  ...
  return (
    <div className="relative w-full h-[300px] flex flex-col items-center justify-center -ml-10">
      <svg ref={containerRef} className="w-full h-full overflow-visible" style={{ touchAction: 'none' }}>
        ...
        {!isUnlocked && (
           <path d="M -50 200 Q 0 160 50 150" fill="none" stroke="#ef4444" strokeWidth="2" opacity="0.4" strokeDasharray="4 4" />
        )}
        ...
        {!isUnlocked && !isDragging && rightPoint.x > 300 && (
          <g className="animate-[pulse_2s_ease-in-out_infinite] opacity-70 pointer-events-none" transform={`translate(${startX.current}, 150)`}>
            ...
            <path d="M -100 -40 Q -50 -50 -20 -15" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" />
            <path d="M -20 -15 L -30 -20 M -20 -15 L -25 -5" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round" />
            <text x="-120" y="-50" fill="#ef4444" fontSize="20" className="font-handwritten" transform="rotate(-10 -120 -50)">Pull string</text>
          </g>
        )}
        ...
        {/* Left fixed knot */}
        <circle cx={leftPoint.x} cy={leftPoint.y} r="6" fill="#ef4444" />
        <circle cx={leftPoint.x} cy={leftPoint.y} r="14" fill="none" stroke="#ef4444" strokeWidth="1" strokeDasharray="2 2" className="animate-spin-slow" />
        ...
        {!isUnlocked && (
          ...
          >
            ...
            <circle cx="0" cy="0" r="10" fill="#ef4444" className="hover:scale-125 transition-transform" />
            <circle cx="0" cy="0" r="20" fill="none" stroke="#ef4444" strokeWidth="1" className={isDragging ? 'opacity-100 scale-150' : 'opacity-0 scale-100'} style={{ transition: 'all 0.3s ease' }} />
          </g>
        )}
      </svg>
